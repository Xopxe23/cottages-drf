...
urlpatterns = [
    ...
    path('<uuid:cottage_id>/reviews/', ListUserCottageReviewView.as_view(), name='review-list'),
    path('<uuid:cottage_id>/reviews/<uuid:pk>/', UpdateDestroyReviewView.as_view(), name='review-edit'),
]
