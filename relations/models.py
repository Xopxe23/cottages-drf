...
class UserCottageReview(models.Model):
    ...
    user = models.ForeignKey(EmailUser, on_delete=models.CASCADE, related_name="reviews", verbose_name="Пользователь")
...
class UserCottageLike(models.Model):
    ...
    user = models.ForeignKey(EmailUser, on_delete=models.CASCADE, related_name="likes", verbose_name="Пользователь")
...
class UserCottageRent(models.Model):
    ...
    user = models.ForeignKey(EmailUser, on_delete=models.CASCADE, related_name="rents", verbose_name="Пользователь")
